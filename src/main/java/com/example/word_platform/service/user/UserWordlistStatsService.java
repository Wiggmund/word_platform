...
public class UserWordlistStatsService {
  ...
  public List<Stats> createStatsRecords(
    ...
    List<Question> fetchedQuestions = questionService.getAllQuestionsByIdAndWordlist(requiredQuestionIds, wordlist);
    ...
    List<Stats> createdRecords = statsService.createStatsRecords(user, wordlist, fetchedQuestions, fetchedWords, dto);
  ...
  private void validateQuestions(
    ...
    if (requiredQuestionIds.size() == fetchedQuestions.size()) return;
  ...
  private void validateWords(
    ...
    if (requiredWordIds.size() == fetchedWords.size()) return;
