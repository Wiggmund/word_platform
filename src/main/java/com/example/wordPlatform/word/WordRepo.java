...
public interface WordRepo extends JpaRepository<WordEntity, Long> {
  Optional<WordEntity> findByValueAndWordlist(String value, WordlistEntity wordlist);
  ...
  List<WordEntity> findAllByListWithAttributes(@Param("wordlist") WordlistEntity wordlistId);
}
